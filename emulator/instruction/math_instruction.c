...
#define INSTRUCTION_INC_R(RR)                                                                              \
    void instruction_INC_##RR() {                                                                          \
        __asm__(                                                                                           \
            ...
            "setz %2\n\t"                                                                                  \
            "seto %3\n\t"                                                                                  \
            : "+r"(Context_instance.RR), "=r"(Context_instance.SF), "=r"(Context_instance.ZF), \
              "=r"(Context_instance.PV)                                                              \
            :);                                                                                            \
        Context_instance.NF = 1;                                                                     \
        Context_instance.CF = Context_instance.ZF;                                             \
        Context_instance.PC++;                                                                             \
    }
...
#define INSTRUCTION_DEC_R(R)                                                                              \
    void instruction_DEC_##R() {                                                                          \
        ...
        if (Context_instance.R == 0) Context_instance.CF = 1;                                       \
        __asm__(                                                                                          \
            "dec %0\n\t"                                                                                  \
            "sets %1\n\t"                                                                                 \
            "setz %2\n\t"                                                                                 \
            "seto %3\n\t"                                                                                 \
            : "+r"(Context_instance.R), "=r"(Context_instance.SF), "=r"(Context_instance.ZF), \
              "=r"(Context_instance.PV)                                                             \
            :);                                                                                           \
...
#define INSTRUCTION_ADD_A_PROCESS(operand)                                                            \
    __asm__(                                                                                          \
        ...
        : "+r"(Context_instance.A), "=r"(Context_instance.SF), "=r"(Context_instance.ZF), \
          "=r"(Context_instance.PV), "=r"(Context_instance.CF)                            \
        : "r"(operand));                                                                              \
    Context_instance.NF = 1;
...
void instruction_INC_HLp() {
    ...
    __asm__(
        ...
        "setz %2\n\t"
        "seto %3\n\t"
        : "+r"(result), "=r"(Context_instance.SF), "=r"(Context_instance.ZF),
          "=r"(Context_instance.PV)
        :);
...
#define INSTRUCTION_ADD_HL_RR(R)                                         \
    void instruction_ADD_HL_##R() {                                      \
        __asm__(                                                         \
            "add %0, %2\n\t"                                             \
            "setc %1\n\t"                                                \
            : "+r"(Context_instance.HL), "=r"(Context_instance.CF) \
...
void test_instruction_math() {
    ...
    check_test(Context_instance.NF == 1);
    ...
    check_test(Context_instance.SF == 0);
    check_test(Context_instance.ZF == 1);
    // Half Carry flag is not implement
    check_test(Context_instance.PV == 0);
    check_test(Context_instance.NF == 1);
    check_test(Context_instance.CF == 1);
